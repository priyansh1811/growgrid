...
const personas = [
  {
    ...
    body: "Don't know where to start? GrowGrid walks you through every decision — with every recommendation explained in plain language. No agri background needed.",
  ...
  },
  {
    ...
    body: 'Evaluating farming potential before you commit capital? Get a financial model, risk assessment, and practice recommendation based on your actual land constraints.',
  ...
  },
  {
    ...
    body: 'Use GrowGrid to generate structured, evidence-backed advisory reports for your clients — faster, deeper, and more defensible than a manual assessment.',
  ...
  return (
    <section id="for-whom" className="bg-cream py-24 sm:py-32">
      <div ref={ref} className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          GrowGrid works for every kind
          <br />
          <span className="font-display italic text-primary-500">of farm decision.</span>
        </motion.h2>
